...
// Removed import for ScrollArea as it will no longer be used here
      ...
      <CardContent className="flex-grow flex flex-col justify-between space-y-4">
        <div>
          ...
          <Dialog open={isDetailsDialogOpen} onOpenChange={setIsDetailsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] flex flex-col overflow-y-auto"> {/* DialogContent handles scrolling */}
              <DialogHeader>
              ...
              {/* Content directly inside DialogContent, now scrollable */}
