...
import StartFlightForm from '@/components/StartFlightForm';
...
const MyBookings = () => {
  ...
  const [isStartFlightFormOpen, setIsStartFlightFormOpen] = useState(false);
  ...
  const handleFlyNow = (booking: FlightBooking) => {
    ...
    setIsStartFlightFormOpen(true);
  };

  const handleFlightSubmitted = () => {
    showSuccess('Flight successfully logged!');
  ...
  return (
    <div className="container mx-auto p-4 pt-24">
      ...
      {selectedBooking && (
        <StartFlightForm
          isOpen={isStartFlightFormOpen}
          onClose={() => setIsStartFlightFormOpen(false)}
          onFlightSubmitted={handleFlightSubmitted}
          bookingDetails={{
            departureAirport: selectedBooking.departure_airport,
            arrivalAirport: selectedBooking.arrival_airport,
            airline: selectedBooking.airline_name,
            aircraftType: selectedBooking.aircraft_type,
            aircraftRegistration: selectedBooking.aircraft_registration,
            flightNumber: selectedBooking.flight_number || '',
            etd: selectedBooking.etd,
